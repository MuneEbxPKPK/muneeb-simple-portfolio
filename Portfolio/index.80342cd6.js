...
})({"1PU7r":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b497ac9c80342cd6";
"use strict";
...
var _skeletonUtilsJs = require("three/examples/jsm/utils/SkeletonUtils.js");
const loader = new (0, _gltfloaderJs.GLTFLoader)();
loader.load("assets/tire.glb/", (e)=>{
    const tireModel = e.scene;
    const tire1 = _skeletonUtilsJs.clone(tireModel);
    const tire2 = _skeletonUtilsJs.clone(tireModel);
    const tire3 = _skeletonUtilsJs.clone(tireModel);
    const tire4 = _skeletonUtilsJs.clone(tireModel);
    (0, _scriptJs.scene).add(tire1);
    (0, _scriptJs.scene).add(tire2);
    (0, _scriptJs.scene).add(tire3);
    (0, _scriptJs.scene).add(tire4);
    function animateTire() {
        tire1.position.set((0, _scriptJs.wheelBody1).position.x, (0, _scriptJs.wheelBody1).position.y, (0, _scriptJs.wheelBody1).position.z);
        tire1.quaternion.set((0, _scriptJs.wheelBody1).quaternion.x, (0, _scriptJs.wheelBody1).quaternion.y, (0, _scriptJs.wheelBody1).quaternion.z, (0, _scriptJs.wheelBody1).quaternion.w);
        tire2.position.set((0, _scriptJs.wheelBody2).position.x, (0, _scriptJs.wheelBody2).position.y, (0, _scriptJs.wheelBody2).position.z);
        tire2.quaternion.set((0, _scriptJs.wheelBody2).quaternion.x, (0, _scriptJs.wheelBody2).quaternion.y, (0, _scriptJs.wheelBody2).quaternion.z, (0, _scriptJs.wheelBody2).quaternion.w);
        tire3.position.set((0, _scriptJs.wheelBody3).position.x, (0, _scriptJs.wheelBody3).position.y, (0, _scriptJs.wheelBody3).position.z);
        tire3.quaternion.set((0, _scriptJs.wheelBody3).quaternion.x, (0, _scriptJs.wheelBody3).quaternion.y, (0, _scriptJs.wheelBody3).quaternion.z, (0, _scriptJs.wheelBody3).quaternion.w);
        tire4.position.set((0, _scriptJs.wheelBody4).position.x, (0, _scriptJs.wheelBody4).position.y, (0, _scriptJs.wheelBody4).position.z);
        tire4.quaternion.set((0, _scriptJs.wheelBody4).quaternion.x, (0, _scriptJs.wheelBody4).quaternion.y, (0, _scriptJs.wheelBody4).quaternion.z, (0, _scriptJs.wheelBody4).quaternion.w);
        requestAnimationFrame(animateTire);
    }
    animateTire();
});
loader.load("assets/car.glb/", (e)=>{
    const car = e.scene;
    (0, _scriptJs.scene).add(car);
    ...
    function animateTire() {
        car.position.set((0, _scriptJs.carBody).position.x, (0, _scriptJs.carBody).position.y + 0, (0, _scriptJs.carBody).position.z + 0);
        car.quaternion.set((0, _scriptJs.carBody).quaternion.x, (0, _scriptJs.carBody).quaternion.y, (0, _scriptJs.carBody).quaternion.z, (0, _scriptJs.carBody).quaternion.w);
        requestAnimationFrame(animateTire);
    }
    animateTire();
...
},{"./script.js":"dV6cC","three/examples/jsm/loaders/GLTFLoader.js":"dVRsF","three/examples/jsm/utils/SkeletonUtils.js":"5hk7d"}],"dVRsF":[function(require,module,exports) {
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5hk7d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1PU7r","edpJG"], "edpJG", "parcelRequire94c2")

//# sourceMappingURL=index.80342cd6.js.map
